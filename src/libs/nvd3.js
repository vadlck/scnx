	...
	nv.models.tooltip = function () {
		...
		*/
		...
		nvtooltip._options = Object.create({}, {
			...
			// Deprecated options
			fixedTop: {
				get: function () { return null; }, set: function (_) {
					// deprecated after 1.8.1
					nv.deprecated('fixedTop', 'feature removed after 1.8.1');
				}
			},
			offset: {
				get: function () { return { left: 0, top: 0 }; }, set: function (_) {
					// deprecated after 1.8.1
			...
			hidden: {
				get: function () { return hidden; }, set: function (_) {
					if (hidden != _) {
						hidden = !!_;
						nvtooltip();
					}
			...
			data: {
				get: function () { return data; }, set: function (_) {
	...
	*/
	...
	nv.models.bullet = function () {
		...
		chart._options = Object.create({}, {
			...
			orient: {
				get: function () { return orient; }, set: function (_) { // left, right, top, bottom
					orient = _;
	...
	nv.models.historicalBarChart = function (bar_model) {
		...
		chart._options = Object.create({}, {
			...
			duration: {
				get: function () { return transitionDuration; }, set: function (_) {
	...
	nv.models.lineChart = function () {
		...
		chart._options = Object.create({}, {
			...
			focusMargin: {
				get: function () { return margin2; }, set: function (_) {
	...
	nv.models.linePlusBarChart = function () {
		...
		chart._options = Object.create({}, {
			...
			switchYAxisOrder: {
				get: function () { return switchYAxisOrder; }, set: function (_) {
	...
	nv.models.parallelCoordinates = function () {
		...
		chart._options = Object.create({}, {
			...
			// deprecated options
			dimensions: {
				get: function () { return dimensionData.map(function (d) { return d.key }); }, set: function (_) {
					// deprecated after 1.8.1
			...
			dimensionFormats: {
				get: function () { return dimensionData.map(function (d) { return d.format }); }, set: function (_) {
					// deprecated after 1.8.1
	...
	nv.models.pie = function () {
		...
		chart._options = Object.create({}, {
			...
			pieLabelsOutside: {
				get: function () { return labelsOutside; }, set: function (_) {
					labelsOutside = _;
			...
			labelFormat: {
				get: function () { return valueFormat; }, set: function (_) {
					valueFormat = _;
			...
			labelType: {
				get: function () { return labelType; }, set: function (_) {
					labelType = _ || 'key';
				}
			}
		});
			...
			selection.each(function (data) {
				...
				if (!showLegend) {
					...
					if (legendPosition === "top") {
						...
						var legY = availableHeight + (margin.bottom - legend.height());
						wrap.select('.nv-legendWrap')
							.attr('transform', 'translate(0,' + legY + ')');
					}
				}
	...
	nv.models.stackedArea = function () {
		...
		chart._options = Object.create({}, {
			...
			style: {
				get: function () { return style; }, set: function (_) {
					style = _;
					switch (style) {
						case 'stack':
							chart.offset('zero');
